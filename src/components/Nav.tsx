...
shadow-[0_0_50px_-10px_rgba(0,255,100,0.3)] flex flex-col p-6 text-white"
          >
            <div className="relative flex items-center justify-center mb-4">
              <h1 className="font-extrabold text-2xl tracking-wide text-white/90 drop-shadow">
                Admin Panel
              </h1>

              <button
                className="absolute right-0 text-white/80 hover:text-red-400 
                     transition-all duration-200 p-1 rounded-lg hover:bg-white/5"
            ...
            <div className="flex items-center gap-3 p-3 mt-3 rounded-xl bg-white/10 hover:bg-white/15 transition-all shadow-inner">
              <div
                ...
                border-2 border-green-400/60 shadow-[0_4px_15px_rgba(0,255,120,0.25)]
            ...
            <div
              className="flex items-center gap-3 text-red-300 font-semibold mt-auto 
            hover:bg-red-500/20 p-3 rounded-full transition-all"
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 md:gap-6 relative">
        ...
        overflow-hidden shadow-md hover:scale-105 transition-transform cursor-pointer  "
