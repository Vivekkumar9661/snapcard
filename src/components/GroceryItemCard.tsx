  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        text-white rounded-full py-2 text-sm font-medium transition-all cursor-pointer"
          ...
          <motion.div
            ...
            className="mt-4 flex items-center justify-center bg-green-50 border border-green-200 rounded-full py-3 px-4 gap-4"
          >
            <button
              className="w-7 h-7 flex items-center justify-center rounded-full bg-green-100
            hover:bg-green-200 transition-all cursor-pointer"
